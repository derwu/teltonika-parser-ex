...
class Codec7 extends Codec {
    ...
    parseAvlRecords() {
        ...
        let priorityAndTimestamp = this.reader.ReadInt32();
        let priorityAndTimeStampBits = priorityAndTimestamp.toString(2).padStart(32, '0');
        let priority = parseInt(priorityAndTimeStampBits.substr(0, 2),2);
    ...
    parseIoElements() {
        ...
        for (var i = 0; i < ioCountInt8; i++) {
            ...
            ioElement.push({
                               id        : property_id,
                               value     : value,
                               label     : this.ioElements()[property_id].label,
                               dimension : this.ioElements()[property_id].dimension,
                               valueHuman: this.ioElements()[property_id].values[value]
                           })
        }
        ...
        for (var i = 0; i < ioCountInt16; i++) {
            ...
            ioElement.push({
                               ...
                               label     : this.ioElements()[property_id].label,
                               dimension : this.ioElements()[property_id].dimension,
                               valueHuman: this.ioElements()[property_id].values?this.ioElements()[property_id].values[value]:""
                           })
        }
